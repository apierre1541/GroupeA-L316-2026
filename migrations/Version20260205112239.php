...
final class Version20260205112239 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE commentaire (id INT AUTO_INCREMENT NOT NULL, libelle VARCHAR(255) NOT NULL, actualite_id INT DEFAULT NULL, INDEX IDX_67F068BCA2843073 (actualite_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
