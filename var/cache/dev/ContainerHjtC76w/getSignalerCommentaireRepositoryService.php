 ...
 */
class getSignalerCommentaireRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\SignalerCommentaireRepository' shared autowired service.
     *
     * @return \App\Repository\SignalerCommentaireRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'SignalerCommentaireRepository.php';

        return $container->privates['App\\Repository\\SignalerCommentaireRepository'] = new \App\Repository\SignalerCommentaireRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
